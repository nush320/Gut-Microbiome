---
title: "Study 4 - Huang DADA Jan 31, 2025"
...
# Identify Primers
```{r}
FWD <- "GTGCCAGCMGCCGCGGTAA"  # F
REV <- "CCGTCAATTCMTTTRAGTTT"  # R
```
...
### Tried diff. filters using (230, 180), (220,160), (200, 150) worked
```{r}
...
saveRDS(seqtab.nochim, file.path(path, "seqtab.nochim_4.rds"))
saveRDS(taxa, file.path(path, "taxa_4.rds"))
saveRDS(taxa.species, file.path(path, "taxa.species_4.rds"))
```
