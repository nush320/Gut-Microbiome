...
```{r}
md <- readRDS("metadata_4.rds") # metadata load
seqtab <- readRDS("seqtab.nochim_4.rds") # seqtab.nochim
taxa <- readRDS("taxa_4.rds") # genus level taxa
```
