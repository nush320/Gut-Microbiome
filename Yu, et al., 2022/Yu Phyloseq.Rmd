...
```{r}
md <- readRDS("metadata_5.rds") # metadata load
seqtab <- readRDS("seqtab.nochim_5.rds") # seqtab.nochim
taxa <- readRDS("taxa_5.rds") # genus level taxa
```
