...
```{r}
md <- readRDS("metadata_3.rds") # metadata load
seqtab <- readRDS("seqtab.nochim_3.rds") # seqtab.nochim
taxa <- readRDS("taxa_3.rds") # genus level taxa
```
