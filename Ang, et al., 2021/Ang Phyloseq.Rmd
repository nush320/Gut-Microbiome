...
```{r}
md <- readRDS("metadata_8.rds") # metadata load
seqtab <- readRDS("seqtab.nochim_8.rds") # seqtab.nochim
taxa <- readRDS("taxa_8.rds") # genus level taxa
```
