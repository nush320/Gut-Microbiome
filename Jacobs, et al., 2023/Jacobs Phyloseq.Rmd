...
```{r}
md <- readRDS("metadata_9.rds") # metadata load
seqtab <- readRDS("seqtab.nochim_9.rds") # seqtab.nochim
taxa <- readRDS("taxa_9.rds") # genus level taxa
```
